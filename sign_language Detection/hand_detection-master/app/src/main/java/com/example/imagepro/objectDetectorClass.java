...
public class  objectDetectorClass {
    ...
    private String get_alphabets(float sign_v) {
        ...
        if(sign_v >= -0.5 & sign_v< 0.5){
            ...
            val = "I";
        }else if (sign_v >= 10.5 & sign_v< 9.5) {
            val = "J";
        }else if (sign_v >= 11.5 & sign_v< 10.5) {
            val = "K";
        }else if (sign_v >= 12.5 & sign_v< 11.5) {
            val = "L";
        }else if (sign_v >= 13.5 & sign_v< 12.5) {
            val = "M";
        }else if (sign_v >= 14.5 & sign_v< 13.5) {
            val = "N";
        }else if (sign_v >= 15.5 & sign_v< 14.5) {
            val = "O";
        }else if (sign_v >= 16.5 & sign_v< 15.5) {
            val = "P";
        }else if (sign_v >= 17.5 & sign_v< 16.5) {
            val = "Q";
        }else if (sign_v >= 18.5 & sign_v< 17.5) {
            val = "R";
        }else if (sign_v >= 19.5 & sign_v< 18.5) {
            val = "S";
        }else if (sign_v >= 20.5 & sign_v< 19.5) {
            val = "T";
        }else if (sign_v >= 21.5 & sign_v< 20.5) {
            val = "U";
        }else if (sign_v >= 22.5 & sign_v< 21.5) {
            val = "V";
        }else if (sign_v >= 23.5 & sign_v< 22.5) {
            val = "w";
